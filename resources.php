...
<html lang="zh-cn">
	<head>
		...
		<style type="text/css">
			...
			.B2 h1 { text-align: left; font-size: 20px; letter-spacing: 1px; }
			.B2 h3 { text-align: right; font-size:  10px; letter-spacing: 1px; }
			.B2 p  { text-align: center; font-size:  15px;margin-bottom: 10px; letter-spacing: 1px;   }
		...
		<article>
			...
			<div class="art-right r">			
						<div class="B_article">		
							...
							<div class="B2">
							<h2 class="art-txt"><a href="addsource.php"><em class="iconfont icon-zan "></em><span>&nbsp;区块链共享资源:</span></a></h2>
							<?php
							include_once ("mysql.php");
							include_once ("page.php");
							$sql ="select count(id)  as total from source";//limit 5
							...
							$sql ="select * from source where $t order by id desc limit $firstCount,$displayPG";
							$query = mysqli_query($link, $sql);  
							...
							<div class="art-model">
							<h2 ><a href="viewsource.php?id=<?php echo $rs['id'];?>" ><?php echo $rs['title'];?></a> </h2>
							<dl class="img-txt">
								<dt>
									<a href="<?php echo iconv_substr($rs['contents'],0,100,"utf-8"); ?>" target="_blank"><img src="img/in1.png" > </a>
								</dt>
								<dd>	<!--截取部分长度内容进行展示--> 
									<a href="<?php echo iconv_substr($rs['contents'],0,100,"utf-8"); ?>" target="_blank">
									<?php echo iconv_substr($rs['contents'],0,44,"utf-8"); ?>
									</a>
									
									<h3 class="dateview"> <span><?php echo "共享时间：".$rs['date']?></span></h3>

									<h3 class="dateview"> <span><?php echo "共享人：".$rs['acter']?></span></h3>
								</dd>
							</dl>
